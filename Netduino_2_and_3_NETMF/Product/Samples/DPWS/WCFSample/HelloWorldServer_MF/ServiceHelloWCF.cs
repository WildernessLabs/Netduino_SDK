...
namespace localhost.ServiceHelloWCF
{
    ...
    public class HelloWCFResponseDataContractSerializer : DataContractSerializer
    {
        ...
        public override object ReadObject(XmlReader reader)
        {
            ...
            if (IsParentStartElement(reader, false, true))
            {
                ...
                reader.Read();
                if (IsChildStartElement(reader, "HelloWCFResult", true, false))
                {
                    reader.Read();
        ...
        public override void WriteObject(XmlWriter writer, object graph)
        {
            ...
            if (WriteParentElement(writer, true, true, graph))
            {
                if (WriteChildElement(writer, "HelloWCFResult", true, false, HelloWCFResponseField.HelloWCFResult))
                {
    ...
    public interface IIServiceHelloWCF
    {

        [OperationContract(Action = "http://localhost/ServiceHelloWCF/IServiceHelloWCF/HelloWCF", ReplyAction = "http://localhost/ServiceHelloWCF/IServiceHelloWCF/HelloWCFResponse")]

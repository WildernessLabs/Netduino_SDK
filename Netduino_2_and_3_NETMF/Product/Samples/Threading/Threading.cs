...
namespace ThreadingSample
{
    ...
    public static class MyThreading
    {
        ...
        {
            // The thread executing this method simulates doing work by sleeping for 
            // 500 milliseconds.
            Thread.Sleep(500);
        }
        ...
        private static void TimerDemo()
        {
            ...
            {
                // Simulate doing other work here by sleeping for 1000ms.
                Thread.Sleep(1000);
            }
        ...
        private static AutoResetEvent s_doSomethingThreadDone =

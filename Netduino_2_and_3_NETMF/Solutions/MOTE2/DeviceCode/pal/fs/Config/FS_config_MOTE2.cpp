...
extern BlockStorageDevice g_PXA271_16_BS;

FileSystemVolume g_MOTE2_FS;

void FS_AddVolumes()
{
    FileSystemVolumeList::AddVolume( &g_MOTE2_FS, "ROOT", 0, 0, &g_FAT32_STREAM_DriverInterface, &g_FAT32_FILE_SYSTEM_DriverInterface, &g_PXA271_16_BS, 0, FALSE );
}

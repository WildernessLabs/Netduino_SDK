...
#if defined(TARGETLOCATION_RAM)
#define LED_COLOR LED1_BLUE
#else
#define LED_COLOR LED1_GREEN
#endif
...
void TinyBooter_OnStateChange( TinyBooterState state, void* data, void ** retData )
{
    switch(state)
    {
        ...
        case State_EnterBooterMode:
            hal_printf( "Waiting..\r\n" );
            CPU_GPIO_SetPinState( LED_COLOR, LED_ON );
            break;
        ...
        case State_MemoryWrite:
            //hal_printf( "Writing: 0x%08x\n", (UINT32)data );
            break;
        case State_MemoryErase:
            hal_printf( "Erasing Sector: 0x%08x\r\n", (UINT32)data );
            break;
        ...
        case State_Launch:
            ...
            CPU_GPIO_SetPinState( LED_COLOR, LED_OFF );
            break;
    }

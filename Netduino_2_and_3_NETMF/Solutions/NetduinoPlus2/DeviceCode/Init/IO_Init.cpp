...
void __section(SectionForBootstrapOperations) BootstrapCode_GPIO() {
	...
	// turn on ENC28J60 power automatically and enable/disable reset
    CPU_GPIO_EnableOutputPin(0x2F, FALSE); // PC15: /PWR_CTRL_ETHERNET
//	CPU_GPIO_DisablePin(0x32, RESISTOR_DISABLED, 0, GPIO_ALT_PRIMARY); // PD2: /ENC_RESET (for lwIP)
    CPU_GPIO_EnableOutputPin(0x32, FALSE); // PD2: /ENC_RESET (for Netduino.IP)
#endif
}

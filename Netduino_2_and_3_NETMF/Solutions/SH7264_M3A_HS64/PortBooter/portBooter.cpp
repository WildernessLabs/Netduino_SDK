...
extern const struct USB_DYNAMIC_CONFIGURATION UsbDefaultConfiguration;
...
struct State
{
    ...
    void Initialize()
    {
        ...
        hal_printf( "Renesae Compiler version %d\r\n", __RENESAS_VERSION__ );
#else
...

    {
        ...
        while(true)
        {
            if(MenuUpdate)
            {
                ...
                case 1:
                    hal_fprintf( STREAM_LCD, "PortBooter v4.0\r\n"                         );

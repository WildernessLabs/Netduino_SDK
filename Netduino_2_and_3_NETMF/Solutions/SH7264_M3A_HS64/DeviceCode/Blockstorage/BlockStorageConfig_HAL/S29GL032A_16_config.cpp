...
#define FLASH_DEVICE_CODE                       0x221d
...
#define SH7264_NOR_TYPE_1   1

// FLASH CHIP IS TYPE_1
#ifdef SH7264_NOR_TYPE_1
...
const BlockRange g_S29GL032A_16_BlockRange1[] =
{
    ...
    { BlockRange::BLOCKTYPE_DEPLOYMENT      , 48, 60 },       // SA48-60- DEPLOYMENT(300000-3CFFFF)
    { BlockRange::BLOCKTYPE_STORAGE_A       , 61, 61 },       // SA61 - Storage A(3D0000-3DFFFF)
    { BlockRange::BLOCKTYPE_STORAGE_B       , 62, 62 },       // SA62- Storage B(3FE000-3EFFFF)
    { BlockRange::BLOCKTYPE_CONFIG          , 63, 63 },       // SA63-64 - ER_Config(3F0000-3FFFFF)
...
const BlockRange g_S29GL032A_16_BlockRange1[] =
{
    { BlockRange::BLOCKTYPE_FILESYSTEM       , 0,  63},
};
#endif
...
#define REGION1_NUM_OF_BLOCKS       64
...
const BlockRange g_S29GL032A_16_BlockRange1[] =
{
    ...
    { BlockRange::BLOCKTYPE_CODE            ,  1, 35 },       // SA1-35 - ER_FLASH (10000-23FFFF)
    { BlockRange::BLOCKTYPE_DEPLOYMENT      , 36, 47 },       // SA36-47 - DEPLOYMENT(240000-2FFFFF)
    { BlockRange::BLOCKTYPE_DEPLOYMENT      , 48, 62 },       // SA48-62- DEPLOYMENT(300000-3EFFFF)
};
...
const BlockRange g_S29GL032A_16_BlockRange1[] =
{
    { BlockRange::BLOCKTYPE_FILESYSTEM       , 0,  62},
};
const BlockRange g_S29GL032A_16_BlockRange2[] =
{
    { BlockRange::BLOCKTYPE_FILESYSTEM      , 0,  7 },       // SA63-70 - ER_Config(3F0000-3FFFFF)
};
#endif

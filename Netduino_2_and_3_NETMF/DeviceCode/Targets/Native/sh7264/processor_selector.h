...
#if !defined(PLATFORM_SH7264)
ERROR - WE SHOULD NOT INCLUDE THIS HEADER IF NOT BUILDING A SH_OS PLATFORM
#endif

/////////////////////////////////////////////////////////
//
// processor and features
#ifndef _PLATFORM_SH7264_SELECTOR_H_
#define _PLATFORM_SH7264_SELECTOR_H_ 1

#define PLATFORM_SH_DEFINED
...
// macros
//    
#define UNUSED_GPIO_PULLDOWN(x) { (UINT8)SH_GPIO::c_Port_##x, (UINT8)RESISTOR_PULLDOWN }
#define UNUSED_GPIO_PULLUP(x)   { (UINT8)SH_GPIO::c_Port_##x, (UINT8)RESISTOR_PULLUP   }
#define UNUSED_GPIO_DISABLED(x) { (UINT8)SH_GPIO::c_Port_##x, (UINT8)RESISTOR_DISABLED }
//
// macros
//
/////////////////////////////////////////////////////////
...
#include "deviceCode\iodefine.h"

#endif // _PLATFORM_ARM_SH7264_SELECTOR_H_ 1
//

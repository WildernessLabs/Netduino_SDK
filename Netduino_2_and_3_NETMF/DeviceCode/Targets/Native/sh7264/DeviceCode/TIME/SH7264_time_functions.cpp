...
{
    return SH7264_TIME_Driver::Initialize();
}

BOOL HAL_Time_Uninitialize()
{
    return SH7264_TIME_Driver::Uninitialize();
}

UINT64 HAL_Time_CurrentTicks()
{
    return SH7264_TIME_Driver::CounterValue();
}

INT64 HAL_Time_TicksToTime( UINT64 Ticks )
{
    return SH7264_TIME_Driver::TicksToTime( Ticks );
}

INT64 HAL_Time_CurrentTime()
{
    return SH7264_TIME_Driver::CurrentTime();
}

void HAL_Time_SetCompare( UINT64 CompareValue )
{
    SH7264_TIME_Driver::SetCompareValue( CompareValue );
}
...
{
    SH7264_TIME_Driver::Sleep_uSec( uSec );
}
...
{
    SH7264_TIME_Driver::Sleep_uSec_Loop( uSec );
}

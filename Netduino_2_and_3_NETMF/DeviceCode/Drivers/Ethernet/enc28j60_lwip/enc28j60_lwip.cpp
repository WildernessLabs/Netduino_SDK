...
bool enc28j60_lwip_setup_device( struct netif *pNetIF )
{
    ...
    enc28j60_lwip_write_spi(SpiConf, ENC28J60_SPI_BIT_FIELD_SET_OPCODE, ENC28J60_EIE, (UINT8)((1 << ENC28J60_EIE_INTIE_BIT) | (1 << ENC28J60_EIE_PKTIE_BIT) | (1 << ENC28J60_EIE_TXIE_BIT) |(1 << ENC28J60_EIE_TXERIE_BIT)));
	...
	/* enabled LEDB as activity LED with stretching and medium blink rate -- see p. 9 of ENC28J60 datasheet */
//    shortData = 0x39D2; // normal stretch
    shortData = 0x39D6; // medium stretch
//    shortData = 0x39DA; // long stretch
//    shortData = 0x3882; // always on
    enc28j60_lwip_write_phy_register(SpiConf, ENC28J60_PHLCON, shortData);
#endif

...
# define OPENSSL_strcmp (int (*)(const char *,const char *))TINYCLR_SSL_STRCMP
#else
# define OPENSSL_strcmp TINYCLR_SSL_STRCMP
#endif
...
extern "C" void OBJ_NAME_do_all(int type,void (*fn)(const OBJ_NAME *,void *arg),void *arg)
	{
	struct doall d;

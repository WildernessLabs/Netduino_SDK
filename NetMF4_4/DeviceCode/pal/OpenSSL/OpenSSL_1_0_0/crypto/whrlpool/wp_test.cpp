...
{
    TINYCLR_SSL_PRINTF("No Whirlpool support\n");
    return(0);
}
#else
...
{ unsigned char md[WHIRLPOOL_DIGEST_LENGTH];
  ...
  WHIRLPOOL_CTX	ctx;
    ...
    TINYCLR_SSL_FPRINTF(OPENSSL_TYPE__FILE_STDOUT,"Testing Whirlpool ");

    WHIRLPOOL("",0,md);
    if (TINYCLR_SSL_MEMCMP(md,iso_test_1,sizeof(iso_test_1)))
    ...
    WHIRLPOOL("a",1,md);
    if (TINYCLR_SSL_MEMCMP(md,iso_test_2,sizeof(iso_test_2)))
    {   TINYCLR_SSL_FFLUSH(OPENSSL_TYPE__FILE_STDOUT);
	TINYCLR_SSL_FPRINTF(OPENSSL_TYPE__FILE_STDERR,"\nTEST 2 of 9 failed.\n");
	return 1;
    }
    ...
    WHIRLPOOL("abc",3,md);
    if (TINYCLR_SSL_MEMCMP(md,iso_test_3,sizeof(iso_test_3)))
    {   TINYCLR_SSL_FFLUSH(OPENSSL_TYPE__FILE_STDOUT);
	TINYCLR_SSL_FPRINTF(OPENSSL_TYPE__FILE_STDERR,"\nTEST 3 of 9 failed.\n");
	return 1;
    }
    ...
    if (TINYCLR_SSL_MEMCMP(md,iso_test_4,sizeof(iso_test_4)))
    {   TINYCLR_SSL_FFLUSH(OPENSSL_TYPE__FILE_STDOUT);
	TINYCLR_SSL_FPRINTF(OPENSSL_TYPE__FILE_STDERR,"\nTEST 4 of 9 failed.\n");
	return 1;
    }
    ...
    if (TINYCLR_SSL_MEMCMP(md,iso_test_5,sizeof(iso_test_5)))
    {   TINYCLR_SSL_FFLUSH(OPENSSL_TYPE__FILE_STDOUT);
	TINYCLR_SSL_FPRINTF(OPENSSL_TYPE__FILE_STDERR,"\nTEST 5 of 9 failed.\n");
	return 1;
    }
    ...
    WHIRLPOOL(	"ABCDEFGHIJKLMNOPQRSTUVWXYZ"
		...
		"0123456789",62,md);
    if (TINYCLR_SSL_MEMCMP(md,iso_test_6,sizeof(iso_test_6)))
    {   TINYCLR_SSL_FFLUSH(OPENSSL_TYPE__FILE_STDOUT);
	TINYCLR_SSL_FPRINTF(OPENSSL_TYPE__FILE_STDERR,"\nTEST 6 of 9 failed.\n");
	return 1;
    }
    ...
    if (TINYCLR_SSL_MEMCMP(md,iso_test_7,sizeof(iso_test_7)))
    {   TINYCLR_SSL_FFLUSH(OPENSSL_TYPE__FILE_STDOUT);
	TINYCLR_SSL_FPRINTF(OPENSSL_TYPE__FILE_STDERR,"\nTEST 7 of 9 failed.\n");
	return 1;
    }
    ...
    if (TINYCLR_SSL_MEMCMP(md,iso_test_8,sizeof(iso_test_8)))
    {   TINYCLR_SSL_FFLUSH(OPENSSL_TYPE__FILE_STDOUT);
	TINYCLR_SSL_FPRINTF(OPENSSL_TYPE__FILE_STDERR,"\nTEST 8 of 9 failed.\n");
	return 1;
    }
    ...
    if (TINYCLR_SSL_MEMCMP(md,iso_test_9,sizeof(iso_test_9)))
    {   TINYCLR_SSL_FFLUSH(OPENSSL_TYPE__FILE_STDOUT);
	TINYCLR_SSL_FPRINTF(OPENSSL_TYPE__FILE_STDERR,"\nTEST 9 of 9 failed.\n");
	return 1;
    }

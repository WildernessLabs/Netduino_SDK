...
#ifdef DEBUG_KEYS
	TINYCLR_SSL_FPRINTF(OPENSSL_TYPE__FILE_STDERR,"Set params index %d oid %s\nq=",
		(params-R3410_2001_paramset),OBJ_nid2sn(params->nid));
	BN_print_fp(OPENSSL_TYPE__FILE_STDERR,q);
...
int gost2001_do_verify(const unsigned char *dgst,int dgst_len,
	...
	BN_print_fp(OPENSSL_TYPE__FILE_STDERR,v);
	TINYCLR_SSL_FPRINTF(OPENSSL_TYPE__FILE_STDERR,"\nz1: ");
	BN_print_fp(OPENSSL_TYPE__FILE_STDERR,z1);
	TINYCLR_SSL_FPRINTF(OPENSSL_TYPE__FILE_STDERR,"\nz2: ");
	BN_print_fp(OPENSSL_TYPE__FILE_STDERR,z2);
#endif	
	C = EC_POINT_new(group);

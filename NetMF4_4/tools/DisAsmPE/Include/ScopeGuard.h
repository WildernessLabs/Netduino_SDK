...
namespace Microsoft
{
    namespace Patterns
    {
        ...
        ///   the Dec. 2000 Issue of Dr Dobb's journal by Andrei 
        ///   Alexandrescu and Petru Marginean. Their implementation
        ///   is more complex due to the lack of functional programming
        ///   paradigms in the C++ language and standard libraries at
        ///   the time they wrote it. This version of the concept of
        ///   ScopeGuard takes full advantage of the latest features
        ///   of C++ 11 and related standard libraries resulting in a
        ///   much simpler implementation that is even more flexible
        //    and powerful than the original.</para>
        ///</remarks>
        class ScopeGuard
        {
        ...
        public:
            ...
            ~ScopeGuard( )
            {
                ...
                catch( ... )
                {
                    ...
                    // can be done about it at run-time. Move on...
                    assert( false );
#endif
                }
            }
...
///   functions, std::function, and C++ Lambda expressions.</para>
///
///<example>
///<code>
...
///<code>
///</example>
#define ON_SCOPE_EXIT2( localName, action ) Microsoft::Patterns::ScopeGuard localName( action )
#define ON_SCOPE_EXIT( action ) ON_SCOPE_EXIT2( SG_VARIABLE(ScopeGuard_), action )

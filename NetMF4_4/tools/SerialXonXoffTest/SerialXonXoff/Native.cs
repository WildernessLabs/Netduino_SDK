...
{
    /// <include file='doc\Native.uex' path='docs/doc[@for="ASCII"]/*' />
    ...
    /// <include file='doc\Native.uex' path='docs/doc[@for="Native"]/*' />
    public sealed class Native
    {
        ...
        public class AccurateTimer
        {
            ...
            private static double Initialize()
            {
                ...
                //return 100 * (double)TimeSpan.TicksPerSecond / (double)ticksPerSecond;

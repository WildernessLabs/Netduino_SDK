...
{
    /// <summary>
    /// The Cryptoki wrapper class for encryption operations.
    /// </summary>
    public class Encryptor : SessionContainer, ICryptoTransform
    {
        ...
        public int TransformBlock(byte[] inputBuffer, int inputOffset, int inputCount, byte[] outputBuffer, int outputOffset)
        {
            ...
            if (!m_isInit) EncryptInit(m_session, m_mech, m_key);

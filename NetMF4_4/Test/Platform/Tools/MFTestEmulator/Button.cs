...
namespace Microsoft.SPOT.Emulator.Sample
{
    ...
    public class Button : Control
    {
        ...
        /// <summary>
        /// The GPIO pin that this button is responsible for toggling.
        /// </summary>
        ...
        /// <summary>
        /// The key that this button should respond to.  Useful mainly if this control is a child of 
        /// a ButtonCollection control that has keyboard focus.
        /// </summary>
        public Keys Key
        {
            get { return _key; }
        ...
        /// <summary>
        /// Paint the control based on the button state, drawing Image or ImagePressed as appropriate.
        /// </summary>
        ...
        /// <summary>
        /// If this control has focus, any keypress will trigger the associated GPIO port.  Normally, this control
        /// will not have focus, but instead be a child of a ButtonCollection.
        /// </summary>
        ...
        /// <summary>
        /// If this control has focus, any keypress will trigger the GPIO port.  Normally, this control
        /// will not have focus, but instead be a child of a ButtonCollection.
        /// </summary>

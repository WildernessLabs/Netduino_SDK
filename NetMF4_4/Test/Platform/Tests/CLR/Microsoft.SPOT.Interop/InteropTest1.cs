...
namespace Microsoft.SPOT.Platform.Test.Interop
{
    public partial class InteropTest 
    {
        ...
        //
        //
        public static byte[] staticArrayTest = new byte[] 
                 { 0x73, 0x03, 0xb1, 0x88, 0xc5, 0x2d, 
                   0x06, 0xe7, 0xd0, 0x12, 0x4e, 0x75, 
                   0xa6, 0x20, 0x64, 0x53, 0xf9, 0x9c, 0xaf, 0xfb };
        ...
        static void RunAllocations(object[] arrObj)
        {
            for (int i = 1; i < arrObj.Length; i++)
           {
               ...
               arr[0] = i;
               arr[1] = 50 * i;
               Log.Comment( "On Cycle " + arr[0] + " Array of  " + arr[1] + " was allocated" );
           }
        }

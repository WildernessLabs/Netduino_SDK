//
//	AES Encrypting Comparison with known vectors in ECB mode.
//
using System;
...
class RijndaelKnown1
{
    ...
    static Boolean TestKnownEnc(Aes aes, Byte[] Key, Byte[] IV, Byte[] Plain, Byte[] Cipher, CipherMode mode, PaddingMode padding)
    {
    ...
    public static Boolean Test(Aes aes)
    {
		...
		bRes = TestKnownEnc(aes, Key, IV, Plain, Cipher, CipherMode.ECB, PaddingMode.None) && bRes;
		...
		bRes = TestKnownEnc(aes, Key1, IV1, Plain1, Cipher1, CipherMode.ECB, PaddingMode.None) && bRes;
		...
		bRes = TestKnownEnc(aes, Key2, IV2, Plain2, Cipher2, CipherMode.ECB, PaddingMode.None) && bRes;
		...
		bRes = TestKnownEnc(aes, Key3, IV3, Plain3, Cipher3, CipherMode.ECB, PaddingMode.None) && bRes;
		...
		bRes = TestKnownEnc(aes, Key4, IV4, Plain4, Cipher4, CipherMode.ECB, PaddingMode.None) && bRes;
		...
		bRes = TestKnownEnc(aes, Key5, IV5, Plain5, Cipher5, CipherMode.ECB, PaddingMode.None) && bRes;

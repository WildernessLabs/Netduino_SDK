//
//	Rijndael Encrypting Comparison with known vectors in CBC mode.
//
using System;
...
//		rjnd.KeySize = 128;
    ...
    public static Boolean Test()
    {
		...
		bRes = TestKnownEnc(Key, IV, Plain, Cipher, CipherMode.CBC, PaddingMode.None) && bRes;
		...
		bRes = TestKnownEnc(Key1, IV1, Plain1, Cipher1, CipherMode.CBC, PaddingMode.None) && bRes;
		...
		bRes = TestKnownEnc(Key2, IV2, Plain2, Cipher2, CipherMode.CBC, PaddingMode.None) && bRes;
		...
		bRes = TestKnownEnc(Key3, IV3, Plain3, Cipher3, CipherMode.CBC, PaddingMode.None) && bRes;
		...
		bRes = TestKnownEnc(Key4, IV4, Plain4, Cipher4, CipherMode.CBC, PaddingMode.None) && bRes;
		...
		bRes = TestKnownEnc(Key5, IV5, Plain5, Cipher5, CipherMode.CBC, PaddingMode.None) && bRes;

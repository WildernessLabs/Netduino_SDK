...
public static class BlockTest
{
	...
	public static PaddingMode[] PaddingModes = new PaddingMode[] { PaddingMode.None, PaddingMode.Zeros, PaddingMode.PKCS7, PaddingMode.ANSIX923, PaddingMode.ISO10126 };
	...
	private const int AesCSPSupportedMajorVer = 5;
	private const int AesCSPSupportedMinorVer = 1;
	
	private static bool AesCSPSupported()
	{

...
{
    public class rng3 : IMFTestInterface
    {
        bool m_isEmulator;
        ...
        static Boolean CompareAndCheck(Byte[] rgb1, Byte[] rgb2)
        {
            int i;
        ...
        public static Boolean Test(Session session)
        {
            ...
            for (int i = 0; i < 1000; i++)
            {
                ...
                rndcsp2.GetNonZeroBytes(barr2);
                if (CompareAndCheck(barr1, barr2)) return false;
            }
        ...
        [TestMethod]
        public MFTestResults RNG3_Test()
        {
            bool bRes = true;

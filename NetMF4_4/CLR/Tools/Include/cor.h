...
EXTERN_GUID(CLSID_CorMetaDataRuntime, 0x005023ca, 0x72b1, 0x11d3, 0x9f, 0xc4, 0x0, 0xc0, 0x4f, 0x79, 0xa0, 0xa3);
...
DECLARE_INTERFACE_(IMetaDataEmit2, IMetaDataEmit)
{
    ...
    STDMETHOD(DefineGenericParam)(          // S_OK or error.
        ...
        mdToken      tkKind,                // [IN] For future use (e.g. non-type parameters)
...
DECLARE_INTERFACE_(INativeImageInstallInfo, IUnknown)
{
    ...
    STDMETHOD (GetConfigString) (
        LPWSTR szConfigString,              // [OUT]
        DWORD * pdwLength                   // [IN|OUT] - Number of WCHARs written including terminating NULL
        ) PURE;

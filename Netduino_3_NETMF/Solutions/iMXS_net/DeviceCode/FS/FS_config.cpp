...
FileSystemVolume g_iMXS_Net_FS;

void FS_AddVolumes()
{
    FileSystemVolumeList::AddVolume( &g_iMXS_Net_FS, "ROOT", 0, 0, &g_FAT32_STREAM_DriverInterface, &g_FAT32_FILE_SYSTEM_DriverInterface, &g_I28F640_16_BS, 0, FALSE );
}

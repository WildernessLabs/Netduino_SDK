...
#define     PRODUCT_NAME_SIZE      28   /* "Micro Framework AT91SAM9RL64 (Evaluation Kit)" */
#define     SERIAL_NAME_SIZE      10   /* "Micro Framework AT91SAM9RL64 (Evaluation Kit)" */
// NOTE: If these two strings are not present, the MFUSB KERNEL driver will *CRASH*
// which, of course, causes Windows to crash
#define     DISPLAY_NAME_SIZE       15   /* "AT91SAM9RL64_EK"*/

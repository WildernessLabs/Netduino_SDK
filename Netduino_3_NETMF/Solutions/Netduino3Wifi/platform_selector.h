...
#ifndef _PLATFORM_Netduino3Wifi_SELECTOR_H_
#define _PLATFORM_Netduino3Wifi_SELECTOR_H_ 1
...
#define HAL_SYSTEM_NAME                     "Netduino3Wifi"
...
//#define SRAM2_MEMORY_Base               0x10000000
//#define SRAM2_MEMORY_Size               0x00010000
...
// UART Configuration
#define STM32_UART         {USART6,USART2, UART4,USART1,USART3, UART7, UART8,USART2}
#define STM32_UART_NUM     {     5,     1,     3,     0,     2,     6,     7,     1} /* uart numbers use zero-based index */
#define STM32_UART_TX_PIN  {  0x26,  0x02,  0x00,  0x16,  0x38,  0x48,  0x41,  0x35}
#define STM32_UART_RX_PIN  {  0x27,  0x03,  0x01,  0x17,  0x39,  0x47,  0x40,  0x36}
#define STM32_UART_RTS_PIN {  0xFF,  0x01,  0xFF,  0xFF,  0xFF,  0xFF,  0xFF,  0x34} /* 0xFF = unused */
#define STM32_UART_CTS_PIN {  0xFF,  0x00,  0xFF,  0xFF,  0xFF,  0xFF,  0xFF,  0x33} /* 0xFF = unused */
...
#endif // PLATFORM_ARM_Netduino3Wifi
//
// drivers
/////////////////////////////////////////////////////////

#endif // _PLATFORM_Netduino3Wifi_SELECTOR_H_

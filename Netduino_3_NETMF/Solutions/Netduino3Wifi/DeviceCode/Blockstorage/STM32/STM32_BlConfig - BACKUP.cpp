...
const BlockRange g_STM32_BlockRange4[] =
{
    { BlockRange::BLOCKTYPE_DEPLOYMENT,   0, 3 },  // 08020000 deployment   64k
};

 const BlockRange g_STM32_BlockRange5[] =
{
    { BlockRange::BLOCKTYPE_DEPLOYMENT,   0, 0 },  // 08020000 deployment   64k
}; 

const BlockRange g_STM32_BlockRange6[] =
{
    { BlockRange::BLOCKTYPE_DEPLOYMENT,   0, 6 },  // 08020000 deployment  896k
};
...
const BlockRegionInfo  g_STM32_BlkRegion[STM32__NUM_REGIONS] =
{
	...
	},
    {
		...
		4,
		0x04000,
        ARRAYSIZE_CONST_EXPR(g_STM32_BlockRange4),
        g_STM32_BlockRange4,
    },
    {
		0x08110000,
		1,
		0x10000,
        ARRAYSIZE_CONST_EXPR(g_STM32_BlockRange5),
        g_STM32_BlockRange5,
	},
    {
		0x08120000,
		7,
		0x20000,
        ARRAYSIZE_CONST_EXPR(g_STM32_BlockRange6),
        g_STM32_BlockRange6,
	}
};

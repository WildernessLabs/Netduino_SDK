...
namespace TemperatureSample
{
    ...
    public sealed class GPIOButtonInputProvider
    {
        ...
        public GPIOButtonInputProvider(PresentationSource source)
        {
            ...
            // Create the pins that will be needed for the buttons.  Default 
            // their values for the emulator.
            ...
            // not set, assume none of them are set and set the left pin back to 
            // the default emulator value.

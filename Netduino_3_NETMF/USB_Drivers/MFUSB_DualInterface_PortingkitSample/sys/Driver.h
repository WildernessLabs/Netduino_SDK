...
#define DRIVERNAME               "MFUSB_DualInterface"
#define LDRIVERNAME             L"MFUSB_DualInterface"
...
typedef struct _ENDPOINT_STATE
{
    ...
    LONG                          handles;                             // number open handles for operations interface
    ...
    KSPIN_LOCK                    FifoLock;
} ENDPOINT_STATE, *PENDPOINT_STATE;
...
typedef struct _DEVICE_EXTENSION {
    ...
    KEVENT                        RecoveryEventAux;                    // event we use to wake up recovery thread
    BOOLEAN                       RecoveryExit;                        // used to terminate recovery thread
    ENDPOINT_STATE                Operations;
    ENDPOINT_STATE                OperationsAux;
...
VOID     OnCancelQueuedReadAux( PDEVICE_OBJECT    fdo, IN PIRP Irp                      );

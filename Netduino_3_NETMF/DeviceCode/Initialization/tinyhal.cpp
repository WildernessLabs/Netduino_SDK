...
#include "..\..\Solutions\Netduino3\DeviceCode\DeploymentTransport\DeploymentTransport.h"
#elif defined(PLATFORM_ARM_Netduino3Ethernet)
#include "..\..\Solutions\Netduino3Ethernet\DeviceCode\DeploymentTransport\DeploymentTransport.h"
#elif defined(PLATFORM_ARM_Netduino3Wifi)
#include "..\..\Solutions\Netduino3Wifi\DeviceCode\DeploymentTransport\DeploymentTransport.h"
#endif
...
#if defined(PLATFORM_ARM_Netduino2) || defined(PLATFORM_ARM_NetduinoPlus2) || defined(PLATFORM_ARM_NetduinoShieldBase) || defined(PLATFORM_ARM_Netduino3) || defined(PLATFORM_ARM_Netduino3Ethernet) || defined(PLATFORM_ARM_Netduino3Wifi)

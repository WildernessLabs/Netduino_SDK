...
#ifndef _SH7264_SMSC_H_1
#define _SH7264_SMSC_H_1 1
...
//Ether
static unsigned short   gmac_address[3] = {0x0000, 0x8736, 0xC469};
...
typedef struct SH7264_SMSC_SOFTC RTP_FAR * PSH7264_SMSC_SOFTC;

PIFACE              iface;

static RTP_BOOL SH7264_SMSC_Init();
static RTP_BOOL SH7264_SMSC_SetupDevice(void);
static BOOL Smsc9218_Xmit_Packet(unsigned char * txbp, int len);
static void SMSC9218_Write_TX_FIFO(DWORD * pdwBuf, DWORD dwDwordCount);
static DWORD SMSC9218_Get_TX_Status_Count();
static void SMSC9218_RX_ISR();
static void SMSC9218_RX_Fast_Forward(DWORD dwDWCount);
//static BOOL Card_Initialize();
//static BOOL Initialize();
//static BOOL Card_Setup();
static BOOL SMSC9218_Initialize_Phy();
static void SMSC9218_Initialize_TX();
static void SMSC9218_Initialize_RX(DWORD dwRXCFG, DWORD dwRXLvl);
static void SMSC9218_Enable_Sw_Flow_Control_FD();
//static void Card_Start();
static BOOL SMSC9218_Initialize_Link();
static BOOL SMSC9218_Auto_Negotiate();
static DWORD SMSC9218_Get_Link_Mode();
static void SMSC9218_Write_Phy_Reg(unsigned short usPhyRegister, unsigned short usPhyData);
static unsigned short SMSC9218_Read_Phy_Reg(unsigned short usPhyRegister);
static void SMSC9218_Write_Mac_Reg(unsigned short usMacRegister, unsigned long ulMacData);
static unsigned long SMSC9218_Read_Mac_Reg(unsigned short usMacRegister);
static BOOL SMSC9218_Wait_MAC_No_Busy();
static BOOL SMSC9218_Wait_MII_No_Busy();
static void SMSC9218_Enable_Interrupt(DWORD dwMask);
//static void InitializeInterrupts(DWORD dwRegINTCFG);
static void SMSC9218_Set_Mac_Filter_Reg();
static void SMSC9218_Set_Packet_Filter_Reg();
static void SMSC9218_Set_Multicast_Address_List();
static void SMSC9218_Enable_Mac_RX();
static void SMSC9218_Disable_Mac_RX();

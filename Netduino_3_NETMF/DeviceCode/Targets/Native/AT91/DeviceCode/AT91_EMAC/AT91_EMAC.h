...
#ifndef _AT91_EMAC_H_1
#define _AT91_EMAC_H_1 1

#include <tinyhal.h>
#include "pal\rtip\rtip.h"
...
// AT91_EMAC
//////////////////////////////////////////////////////////////////////////////
struct AT91_EMAC_SOFTC
{
    PIFACE          iface;
    struct          ether_statistics stats;
    RTP_UINT8       mac_address[6];
};
typedef struct AT91_EMAC_SOFTC RTP_FAR * PAT91_EMAC_SOFTC;
...
/* Function Prototypes */
void AT91_EMAC_Init(PAT91_EMAC_SOFTC sc);

void AT91_EMAC_EnableMdio(void);

void AT91_EMAC_DisableMdio(void);

void AT91_EMAC_SetLinkSpeed(BOOL speed, BOOL fullduplex);

void AT91_EMAC_EnableMII(void);
...
BOOL AT91_EMAC_SetMCast(PIFACE pi);

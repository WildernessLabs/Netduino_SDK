#ifndef _DM9161_MII_LWIP_H_
#define _DM9161_MII_LWIP_H_
...
#define DM9161_MFP SC           (1 << 2)  // MF Preamble Suppression Control
...
//--//
BOOL dm9161_lwip_mii_Init(void);
BOOL dm9161_lwip_AutoNegotiate(void);
BOOL dm9161_lwip_GetLinkSpeed(BOOL applySetting);
BOOL dm9161_lwip_GetLinkStatus(void);
#endif // _DM9161_MII_LWIP_H_

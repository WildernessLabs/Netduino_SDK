...
#define SOCK_NETWORKCONFIGURATION_FLAGS_EXTENDED            0x00008000
...
// extended network configuration flags
#define SOCK_NETWORKCONFIGURATIONEXT_FLAGS_DHCPV6_IPADDR       0x00000001
#define SOCK_NETWORKCONFIGURATIONEXT_FLAGS_DHCPV6_DNSADDRS     0x00000002
/* 
 * NOTE: IPv4-only == IPv4 stack; IPv6-only == IPv6 stack; IPv4 | IPv6 == Dual IPv4+IPv6 stack 
 */
#define SOCK_NETWORKCONFIGURATIONEXT_FLAGS_IPV4_SUPPORTED      0x00000004
#define SOCK_NETWORKCONFIGURATIONEXT_FLAGS_IPV6_SUPPORTED      0x00000008

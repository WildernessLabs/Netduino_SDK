...
//
// Changes from the default lwipopts.h:
//
//        a. Increased send buffer size form 4 * MSS to 32 *MSS
//        b. Decreased low watermark  from 2 * MSS to 1 * MSS
//        c. Increased send queue length  from 15 to 256.
//        d. Increased MEM_SIZE from (64 * 1024) to (1024 * 1024).
//
////////////////////////////////////////////////////////////////////
#ifndef _LWIPOPTS_H_
#define _LWIPOPTS_H_
...
#define TCP_SNDLOWAT            TCP_SND_BUF/32
 ...
 * in use by lwIP or applications. This enhances performance if sending to a
 * small, reasonably static number of hosts. Typically for embedded devices.
 */

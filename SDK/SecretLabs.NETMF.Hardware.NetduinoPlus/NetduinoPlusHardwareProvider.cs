...
namespace SecretLabs.NETMF.Hardware.NetduinoPlus
{
    internal class NetduinoPlusHardwareProvider : HardwareProvider
    {
        static NetduinoPlusHardwareProvider()
        {
            Microsoft.SPOT.Hardware.HardwareProvider.Register(new NetduinoPlusHardwareProvider());
        }
        ...
        override public void GetSerialPins(string comPort, out Cpu.Pin rxPin, out Cpu.Pin txPin, out Cpu.Pin ctsPin, out Cpu.Pin rtsPin)
        {
            switch (comPort)
            {
                ...
                case "COM2":
                    ...
                    ctsPin = Pins.GPIO_PIN_A_4;
                    rtsPin = Pins.GPIO_PIN_A_3;
                    break;
                default:
    ...
    public static class Pins
    {
        ...
        public const Cpu.Pin GPIO_PIN_D2 = GPIO_PIN_A_0; // PA0/RXD0
        //
        internal const Cpu.Pin GPIO_PIN_A_1 = (Cpu.Pin)1; // PA1/TXD0
        public const Cpu.Pin GPIO_PIN_D3 = GPIO_PIN_A_1; // PA1/TXD0
        //
        internal const Cpu.Pin GPIO_PIN_A_3 = (Cpu.Pin)3; // PA3/RTS0
        public const Cpu.Pin GPIO_PIN_D7 = GPIO_PIN_A_3; // PA3/RTS0
        //
        internal const Cpu.Pin GPIO_PIN_A_4 = (Cpu.Pin)4; // PA4/CTS0
        public const Cpu.Pin GPIO_PIN_D8 = GPIO_PIN_A_4; // PA4/CTS0
        //
        internal const Cpu.Pin GPIO_PIN_A_10 = (Cpu.Pin)10; // PA10/TWD
        public const Cpu.Pin GPIO_PIN_A4 = GPIO_PIN_A_10; // PA10/TWD (muxed with AD4)
        //
        internal const Cpu.Pin GPIO_PIN_A_11 = (Cpu.Pin)11; // PA11/TWCK
        public const Cpu.Pin GPIO_PIN_A5 = GPIO_PIN_A_11; // PA11/TWCK (muxed with AD5)
        //
        internal const Cpu.Pin GPIO_PIN_A_12 = (Cpu.Pin)12; // PA12/SPI_NPCS0
        public const Cpu.Pin GPIO_PIN_D4 = GPIO_PIN_A_12; // PA12/SPI_NPCS0
        //
        internal const Cpu.Pin GPIO_PIN_A_16 = (Cpu.Pin)16; // PA16/SPI0_MISO
        public const Cpu.Pin GPIO_PIN_D12 = GPIO_PIN_A_16; // PA16/SPI0_MISO
        //
        internal const Cpu.Pin GPIO_PIN_A_17 = (Cpu.Pin)17; // PA17/SPI0_MOSI
        public const Cpu.Pin GPIO_PIN_D11 = GPIO_PIN_A_17; // PA17/SPI0_MOSI
        //
        internal const Cpu.Pin GPIO_PIN_A_18 = (Cpu.Pin)18; // PA18/SPI0_SPCK
        public const Cpu.Pin GPIO_PIN_D13 = GPIO_PIN_A_18; // PA18/SPI0_SPCK
        //
        internal const Cpu.Pin GPIO_PIN_A_27 = (Cpu.Pin)27; // PA27/DRXD/PCK3
        public const Cpu.Pin GPIO_PIN_D0 = GPIO_PIN_A_27; // PA27/DRXD/PCK3
        //
        internal const Cpu.Pin GPIO_PIN_A_28 = (Cpu.Pin)28; // PA28/DTXD
        public const Cpu.Pin GPIO_PIN_D1 = GPIO_PIN_A_28; // PA28/DTXD
        //
        internal const Cpu.Pin GPIO_PIN_A_29 = (Cpu.Pin)29; // PA29/FIQ/SPI1_NPCS3
        public const Cpu.Pin ONBOARD_SW1 = GPIO_PIN_A_29; // PA29/FIQ/SPI1_NPCS3
        //
        internal const Cpu.Pin GPIO_PIN_B_19 = (Cpu.Pin)51; // PB19/PWM0/TCLK1
        public const Cpu.Pin GPIO_PIN_D5 = GPIO_PIN_B_19; // PB19/PWM0/TCLK1
        //
        internal const Cpu.Pin GPIO_PIN_B_20 = (Cpu.Pin)52; // PB20/PWM1/PCK0
        public const Cpu.Pin GPIO_PIN_D6 = GPIO_PIN_B_20; // PB20/PWM1/PCK0
        //
        internal const Cpu.Pin GPIO_PIN_B_21 = (Cpu.Pin)53; // PB21/PWM2/PCK1
        public const Cpu.Pin GPIO_PIN_D9 = GPIO_PIN_B_21; // PB21/PWM2/PCK1
        //
        internal const Cpu.Pin GPIO_PIN_B_22 = (Cpu.Pin)54; // PB22/PWM3/PCK2
        public const Cpu.Pin GPIO_PIN_D10 = GPIO_PIN_B_22; // PB22/PWM3/PCK2
        //
        internal const Cpu.Pin GPIO_PIN_B_23 = (Cpu.Pin)55; // PB23/TIOA0/DCD1
        public const Cpu.Pin ONBOARD_LED = GPIO_PIN_B_23; // PB23/TIOA0/DCD1
        //
        internal const Cpu.Pin GPIO_PIN_B_27 = (Cpu.Pin)59; // PB27/TIOA2/PWM0/AD0
        public const Cpu.Pin GPIO_PIN_A0 = GPIO_PIN_B_27; // PB27/TIOA2/PWM0/AD0
        //
        internal const Cpu.Pin GPIO_PIN_B_28 = (Cpu.Pin)60; // PB28/TIOB2/PWM1/AD1
        public const Cpu.Pin GPIO_PIN_A1 = GPIO_PIN_B_28; // PB28/TIOB2/PWM1/AD1
        //
        internal const Cpu.Pin GPIO_PIN_B_29 = (Cpu.Pin)61; // PB29/PCK1/PWM2/AD2
        public const Cpu.Pin GPIO_PIN_A2 = GPIO_PIN_B_29; // PB29/PCK1/PWM2/AD2
        //
        internal const Cpu.Pin GPIO_PIN_B_30 = (Cpu.Pin)62; // PB30/PCK2/PWM3/AD3
        public const Cpu.Pin GPIO_PIN_A3 = GPIO_PIN_B_30; // PB30/PCK2/PWM3/AD3
        //
